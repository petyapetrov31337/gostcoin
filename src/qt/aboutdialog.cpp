	...
	ui(new Ui::AboutDialog)
{
	...
	ui->copyrightLabel->setText(
		...
		tr("Copyright") + QString(" &copy; 2017-%1 ").arg(COPYRIGHT_YEAR) + tr("The Gostcoin developers") + QString("<br>") + 
		tr("Copyright") + QString(" &copy; 2018- ").arg(COPYRIGHT_YEAR) + tr("The SPbCoin developers")
	);
}
