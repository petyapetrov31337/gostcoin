...
uint256 hashGenesisBlock("0x00000bdb105783f16a2b920a45cbb2b693a0305982169ab2d70260ac74a905b0");
...
int64 CTransaction::nMinTxFee = 200000;
/** Fees smaller than this (in satoshi) are considered zero fee (for relaying) */
int64 CTransaction::nMinRelayTxFee = 200000;
...
static const int64 nTargetSpacing = 3.42 * 60;// SPbCoin: 3.42 minutes
...
{
    static const int64 BlocksTargetSpacing = 60 * 0.2; //3 * 60; //12 sec --- 3 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000bdb105783f16a2b920a45cbb2b693a0305982169ab2d70260ac74a905b0");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = fTestNet ? "20/Jul/2017: PlazRulezVseProstoIJasno" : "27/04/2018 - SPbCoin Start - Bitcoin 9274$";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		if (fTestNet)
			assert(block.hashMerkleRoot == uint256("0x07fb2590b8899f4a65388470da7d477cfc43fbf3216a644d1d3ad3edb4f01af8"));
		else	
        	assert(block.hashMerkleRoot == uint256("0x07fb2590b8899f4a65388470da7d477cfc43fbf3216a644d1d3ad3edb4f01af8"));
        block.print();
...
CBlockTemplate* CreateNewBlock(const CScript& scriptPubKeyIn)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!vecPriority.empty())
        {
            ...
            // transactions:
            if (!fSortedByFee &&
                ((nBlockSize + nTxSize >= nBlockPrioritySize) || (dPriority < COIN * 420 / 250)))
            {
                fSortedByFee = true;
